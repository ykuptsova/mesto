...
const dom = {
  ...
  popupProfile: {
    ...
    submitButton: document.querySelector(
      '.popup_type_profile .popup__save-button',
    ),
    closeButton: document.querySelector(
      '.popup_type_profile .popup__close-button',
    ),
    formElement: document.querySelector('.popup_type_profile .popup__form'),
    inputName: document.querySelector(
      '.popup_type_profile .popup__form .popup__input_type_name',
    ),
    inputInfo: document.querySelector(
      '.popup_type_profile .popup__form .popup__input_type_info',
    ),
  },
  ...
  popupPlace: {
    ...
    submitButton: document.querySelector(
      '.popup_type_card-add .popup__save-button',
    ),
    closeButton: document.querySelector(
      '.popup_type_card-add .popup__close-button',
    ),
    formElement: document.querySelector('.popup_type_card-add .popup__form'),
    inputName: document.querySelector(
      '.popup_type_card-add .popup__form .popup__input_type_name',
    ),
    inputInfo: document.querySelector(
      '.popup_type_card-add .popup__form .popup__input_type_info',
    ),
  },
  ...
  popupPicture: {
    ...
    description: document.querySelector(
      '.popup_type_picture .popup__image-description',
    ),
    closeButton: document.querySelector(
      '.popup_type_picture .popup__close-button',
    ),
  },
}
